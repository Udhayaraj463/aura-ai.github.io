...
/* A corridor of images riding two rails toward the viewer. Perspective does
 * the work: as a card's z grows it gets bigger and its screen x sweeps outward
 * from the vanishing point. Depth is authored as apparent size (geometric), the
 * rails open hard early then hold, and cards are born across the axis so the
 * throat never opens up. All lengths are cqw, so the shape is size-independent. */
...
export function ImageStreamHero({
  ...
  return (
    ...
    >
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    animationDelay: `${-(i / cards) * speed}s`,
      ...
      <div className="pointer-events-none absolute inset-0 bg-veil" aria-hidden />
